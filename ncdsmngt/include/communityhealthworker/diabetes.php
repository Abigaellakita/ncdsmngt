...
<html>
<head>
    <title>Diabetes Triage Form</title>
</head>
<body>
    <?php
      include("../header.php");
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center my-3">Diabete's Triage Form</h5>
                     ...
                     <?php
                        ...
                        if (isset($_POST['send'])) {
                            ...
                            if (empty($patientname)) {
                                ...
                                $query = "INSERT INTO diabetesreport(patientname,height,weight,bloodpressure,bloodsugar,appearance,concerns,medication,conclusion,username,date_send) VALUES('$patientname','$height','$weight','$bloodpressure','$bloodsugar','$appearance','$concerns','$medication','$conclusion','$user',NOW())";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 jumbotron bg-info">
                                    ...
                                    <form method="post">
                                        ...
                                        <input type="text" name="bloodsugar" class="form-control" autocomplete="off" placeholder="Enter Patient's Blood Sugar">
