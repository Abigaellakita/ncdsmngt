...
if (isset($_POST['login'])) {
  ...
  $q = "SELECT * FROM chws WHERE username='$username' AND password='$password'";
  ...
  if (count($error)==0) {
    ...
    if (mysqli_num_rows($res)) {
      ...
      header("Location:communityhealthworker/index.php");
    }else{
...
<html>
<head>
	<title>Community Health Worker Login Page</title>
</head>
  	...
  	<div class="col-md-12">
  		<div class="row">
  			...
  			<div class="col-md-6 jumbotron my-3">
  				<h5 class="text-center my-2 ">Community Health Worker Login</h5>
          ...
          <div>
            ...
            ?>
  				...
  				<form method="post">
  					...
  					<p>Don't have an account<a href="chwregister.php">Register Now!!!</a></p>
  				</form>
  			</div>
  			<div class="col-md-3">
