...
if (isset($_POST['register'])) {
	...
	if (empty($firstname)) {
		...
		$error['register'] = "Enter Email Address";
          ...
          $error['register'] = "Enter Your Speciality";
	}else if ($gender =="") {
     ...
     if (count($error) == 0) {
     	...
     	$query = "INSERT INTO healthcareworkers(firstname,surname,username,email,speciality,gender,phone,county,subcounty,hospitals,password,date_reg,status,profile) VALUES('$firstname','$surname','$username','$email','$speciality','$gender','$phone','$county','$subcounty','$hospitals','$password',NOW(),'Pending','healthcareworker.jpg')";
     	...
     	if ($result) {
     		...
     		header("Location: healthcareworkerlogin.php");
     	}else{
     			...
     			<div class="col-md-6 my-3 jumbotron">
                    ...
                    <div>
     				...
     				<form method="post">
     					...
     					<div class="form-group">
     						...
     						<input type="text" name="email" class="form-control" autocomplete="off" placeholder="Enter Email Address" value="<?php
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" name="speciality" class="form-control" autocomplete="off" placeholder="Enter Your Speciality" value="<?php
                                   if(isset($_POST['speciality'])) echo $_POST['speciality'];
                                   ?>">
     					</div>
                         ...
                         <p>I already have an account<a href="healthcareworkerlogin.php">Click here</a> </p>
     				</form>
     			</div>
     			<div class="col-md-3">
