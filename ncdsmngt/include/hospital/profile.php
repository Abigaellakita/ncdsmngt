...
<html>
<head>
    <title>Hospital's Profile Page</title>
</head>
<body>
      <?php
       include("../header.php");
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    $query = "SELECT * FROM hospitals WHERE username='$hospital'";
                                    ...
                                    if (isset($_POST['upload'])) {
                                        ...
                                        if (empty($img)) {
                                            ...
                                            $query = "UPDATE hospitals SET profile='$img' WHERE username='$hospital'";
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php
                                       if (isset($_POST['change_username'])) {
                                           ...
                                           if (empty($username)) {
                                              ...
                                              $query = "UPDATE hospitals SET username='$username' WHERE username='$hospital'";
                                    ...
                                    <?php
                                       if ($_POST['change_pass']) {
                                           ...
                                           $ol = "SELECT * FROM hospitals WHERE username='$hospital'";
                                           ...
                                           if ($old != $row['password']) {
                                            ...
                                            $query = "UPDATE hospitals SET password='$new' WHERE username='$hospital'";
