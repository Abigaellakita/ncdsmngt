...
<html>
<head>
    <title>Healthcare Worker's Profile Page</title>
</head>
<body>
      <?php
       include("../header.php");
                    ...
                    <div class="container-fluid">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <?php
                                    $hcw = $_SESSION['healthcare worker'];

                                    $query = "SELECT * FROM healthcareworkers WHERE username='$hcw'";
                                    ...
                                    if (isset($_POST['upload'])) {
                                        ...
                                        if (empty($img)) {
                                            ...
                                            $query = "UPDATE healthcareworkers SET profile='$img' WHERE username='$hcw'";
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php
                                       if (isset($_POST['change_username'])) {
                                           ...
                                           if (empty($username)) {
                                              ...
                                              $query = "UPDATE healthcareworkers SET username='$username' WHERE username='$hcw'";

                                              $res = mysqli_query($connect,$query);

                                              if ($res) {
                                                  $_SESSION['healthcare worker'] = $username;
                                              }
                                           }
                                       }
                                    ?>
                                    ...
                                    <?php
                                       if ($_POST['change_pass']) {
                                           ...
                                           $ol = "SELECT * FROM healthcareworkers WHERE username='$hcw'";
                                           ...
                                           if ($old != $row['password']) {
                                            ...
                                            $query = "UPDATE healthcareworkers SET password='$new' WHERE username='$hcw'";
